...
export function InstagramImportForm({ onClose }: { onClose: () => void }) {
  ...
  return <div className="instagram-import-form">
      ...
      <p>Bring image slides from a post accessible to your connected Instagram professional account into a new editable carousel.</p>
